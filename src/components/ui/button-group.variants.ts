...
export const buttonGroupVariants = cva(
  [
    ...
    "has-[>[data-slot=button-group]]:gap-2 *:data-[slot=input]:px-4",
    "has-[>[data-variant=outline]]:*:data-[slot=input-group]:border-border",
    "has-[>[data-variant=outline]]:*:data-[slot=input-group]:px-2.5",
    ...
    variants: {
      orientation: {
        horizontal: [
          ...
          "[&>*:not(:last-child)]:rounded-r-none [&>[data-slot]:not(:has(~[data-slot]))]:rounded-none!",
        ],
        vertical: [
          "flex-col [&>*:not(:first-child)]:rounded-t-none [&>*:not(:first-child)]:border-t-0",
          "[&>*:not(:last-child)]:rounded-b-none [&>[data-slot]:not(:has(~[data-slot]))]:rounded-none!",
        ],
      },
    },
    defaultVariants: {
