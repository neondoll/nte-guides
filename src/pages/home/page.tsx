...
import { CastleIcon, ShieldIcon, SwordsIcon, UsersRoundIcon } from "@/components/ui/icon";
...
const SECTIONS: Array<Section> = [
  ...
  { icon: CastleIcon, title: "999 ночей", description: "", to: PATHS.NineHundredAndNinetyNineNights },
];
