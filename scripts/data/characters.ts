...
export default {
  Adler: {
    ...
    arcTypeId: ArcTypeIds.Condensate,
  ...
  Chaos: {
    ...
    roleId: CharacterRoleIds.Damage,
    awakeningSkills: {
      1: "Пронзительное чутьё",
      2: "Обвинение / Грех",
      3: "Тлеющая вспышка",
      4: "Тонущий прилив",
      5: "Взор в бездну",
      6: "Ложное происхождение",
    },
    skills: { BasicAttack: "Погоня", Skill: "Метка сомнения", Ultimate: "Возмездие", SupportSkill: "Натиск" },
    version: "1.1",
    image: image("chaos.png"),
    imageWithElementAndRank: image("chaos-with-element-and-rank.png"),
  },
  Chiz: {
  ...
  Shinku: {
    ...
    awakeningSkills: {
      1: "Дождливая аллея",
      2: "Предрассветная тренировочная площадка",
      3: "Закатный пляж",
      4: "Снежный склон",
      5: "Комната смеха",
      6: "Драконье сокровище",
    },
    skills: {
      BasicAttack: "Базовая атака: Особые боевые искуства",
      Skill: "Стремительный прорыв",
      Ultimate: "Сверхспособность: Багровая ярость",
      SupportSkill: "Прорывная тактика",
    },
    version: "1.2",
    image: image("shinku.png"),
  },
  Skia: {
...
} as Record<keyof typeof CharacterIds, Character>;
