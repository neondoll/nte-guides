...
export default {
  ...
  Lacrimosa: {
    ...
    recommendedCartridges: [{ id: CartridgeIds.Diabolos }, { id: CartridgeIds.ShadowCreed }],
    ...
    targetAttributes: ["2200+ атаки", "50-80% шанса крита", "от 50% бонуса к хаосу"],
    recommendedAwakeningSkills: {
      6: { priority: 1 },
      2: { priority: 2 },
      3: { priority: 3 },
    ...
    bestTeams: [
      {
        title: "Команда с Сакири",
        slot1: [CharacterIds.Lacrimosa],
        slot2: [CharacterIds.Haniel],
        slot3: [CharacterIds.Sakiri],
        slot4: [CharacterIds.Hotori],
      },
      {
        title: "Команда с Фадией",
        slot1: [CharacterIds.Lacrimosa],
        slot2: [CharacterIds.Haniel],
        slot3: [CharacterIds.Fadia],
        slot4: [CharacterIds.Hotori],
      ...
      {
        title: "Метообразующий Диссонанс",
        slot1: [CharacterIds.Lacrimosa],
        slot2: [CharacterIds.Daffodill],
        slot3: [CharacterIds.Sakiri],
        slot4: [CharacterIds.Haniel],
        explanation: "Все работают на урон одной Лакримозы",
      },
      {
        title: "Двойной DoT-урон",
        slot1: [CharacterIds.Lacrimosa],
        slot2: [CharacterIds.Baicang],
        slot3: [CharacterIds.Sakiri],
        slot4: [CharacterIds.Fadia],
        explanation: "Здесь главный на поле - Байканг, а Лакримоза сама работает «из кармана»",
      },
      {
      ...
      },
      {
        ...
        slot3: [CharacterIds.Daffodill],
        slot4: [CharacterIds.Sakiri],
        explanation: "Вся команда готовит одну идеальную точку для ядерного взрыва Лакримозы",
      },
      {
        title: "Бюджетный F2P-вариант",
        slot1: [CharacterIds.Lacrimosa],
        slot2: [CharacterIds.Aurelia],
        slot3: [CharacterIds.Haniel],
        slot4: [CharacterIds.Hathor, CharacterIds.Skia],
        explanation: "Всё строится на спаме циклов эспера",
      },
    ],
    videoSourceIds: [
